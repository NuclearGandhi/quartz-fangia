...
import { FullSlug, SimpleSlug, resolveRelative, simplifySlug, RelativeURL } from "../util/path"
...
export default ((opts?: Partial<BreadcrumbOptions>) => {
  ...
  const Breadcrumbs: QuartzComponent = ({
    ...
    const crumbs: CrumbData[] = pathNodes.map((node, idx) => {
      const crumb = formatCrumb(node.displayName, fileData.slug!, simplifySlug(node.slug), allFiles)
      if (idx === 0) {
